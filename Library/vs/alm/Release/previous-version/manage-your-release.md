...
* **Have you set up a build definition for your app using Team Build?** Go 
  **[here](https://www.visualstudio.com/get-started/build/build-your-app-vs)** to learn how.
* **Do you want to use an on-premises server or the cloud to manage your releases?** 
  ...
  on Visual Studio Online instead.
...
* **Using Release Management as a service on Visual Studio Online**: 
  You need a **[Visual Studio Online account](https://www.visualstudio.com/get-started/setup/sign-up-for-visual-studio-online)**. 
...
Visual Studio Online URL or an on-premises server URL. 
...
![Getting started screen to help you with your release process steps](_img/manage-release-03.png) 
...
[Windows PowerShell](https://msdn.microsoft.com/en-us/library/dd835506%28v=vs.85%29.aspx), 
...
for hands-on labs to try Release Management and other ALM products.
