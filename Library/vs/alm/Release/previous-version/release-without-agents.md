...
ms.TocTitle: Release without agents
ms.ContentId: 3C4A0EA1-C4ED-4674-8E9F-AE54D6DA05C0
...
**[here](http://azure.microsoft.com/en-us/pricing/free-trial/)**.
...
environment in Release Management.  
 ...
 1. In the Azure portal, create the VMs that you want to use in your 
   ...
   To 
   [add a VM to a specific cloud service](http://azure.microsoft.com/en-us/documentation/articles/cloud-services-connect-virtual-machine/), 
...
Use on-premises environments if you want to deploy using Chef.
 ...
 1. For PowerShell or DSC deployment, enable PowerShell remoting and set up the 
   ...
   **[here](https://msdn.microsoft.com/en-us/library/aa384372%28v=vs.85%29.aspx)**, 
 ...
 1. Add the deployment actions from the toolbox based on your environment type 
   ...
   **[here](#AzureActions)**.
   ...
   files with a command to generate a .mof file at the end.
        ...
        FileCopy -ConfigurationData $ConfigData â€"Verbose
