...
ms.TocTitle: Trigger a release
ms.ContentId: A6079FE1-80FC-4C98-8F4A-832AB99CC5D3
...
**[do that now](https://msdn.microsoft.com/en-us/library/ms252495.aspx)**.

## Configure your build process
 
 1. If you don't have permission to edit build definitions, 
  **[get them now](https://msdn.microsoft.com/en-us/library/ms252587%28v%3Dvs.140%29.aspx)**.

 1. From Visual Studio, Team Explorer, 
  **[connect to the team project](https://msdn.microsoft.com/en-us/library/ms181475%28v%3Dvs.140%29.aspx)** 
 ...
 * [Deploying Azure Cloud Service using Release Management](http://blogs.msdn.com/b/visualstudioalm/archive/2015/02/09/deploying-azure-cloud-service-using-release-management.aspx) 
