Title: Get started using Git in Visual Studio
ms.TocTitle: Get started
Description: Get started using Git in Visual Studio
toc: show
ms.ContentId: BFDE8FAF-63B8-4BC9-9A24-32EE2CA73C13
...
If you want to work in a centralized version control system, you can instead use [Team Foundation Version Control](http://msdn.microsoft.com/en-us/library/ms181237) (TFVC).
...
[//]: # (Fix the 2015 link)
* Install [Visual Studio 2013](http://go.microsoft.com/fwlink/?LinkId=309297) or [Visual Studio 2015 RC](https://www.visualstudio.com/en-us/downloads/visual-studio-2015-downloads-vs)
...
0. Sign in to Visual Studio Online from Visual Studio.
...
0. The new app appears under the Included Changes section.  Enter a commit message and click the **Commit and Push** button to commit the changes to your local repo then push your changes to Visual Studio Online.
...
#### Q: How do I create a team project on Visual Studio Online?
* [Sign up and create your team project](https://www.visualstudio.com/get-started/setup/sign-up-for-visual-studio-online).  Be sure to select **Git** from the version control options:
...
* [Set up TFS on a server](https://msdn.microsoft.com/en-us/library/hh561426.aspx).
* [Create a team project](https://msdn.microsoft.com/en-us/library/ms181477.aspx).  Be sure to select **Git** from the version control options:
...
* [Make sure you're set up to use the command prompt](/Library/vs/alm/Code/git/command-prompt.md#set_up)

 ![Prompt to install Git command prompt tools](_img/command-prompt/IC675719.png)

* Get the clone URL from the CODE hub in Visual Studio Online.

For the Fabrikam project on VSO, the command to clone would look like this:
...
When you're ready to publish your topic branch to the repo on VSO, push the changes:
