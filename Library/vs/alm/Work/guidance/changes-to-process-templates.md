Title: Changes made to process templates | Team Foundation Server
Description: Summarizes the changes made to process templates to support updating existing team projects after a TFS upgrade
ms.TocTitle: Changes made to process templates
ms.ContentId: 1541C32C-FD7A-4415-A282-06DF14D1F688



*This topic applies primarily to team projects hosted on an on-premises Team Foundation Server (TFS). Team projects on Visual Studio Online [update automatically with each service upgrade](https://www.visualstudio.com/news/release-archive-vso). To update a custom team project hosted on Visual Studio Online, see [Import process](../import-process/import-process.md).*

 
#Changes made to process templates

To support the addition of new features, changes are introduced periodically to the default process templates. A [process template defines the building blocks](../guidance/choose-process.md) of the work item tracking system as well as other sub-systems you access through the web portal for an on-premises Team Foundation Server (TFS).  
...
<td>
<p>Added the Bugs Behavior feature, and enhancements to the Planning Tools and Portfolio Backlogs features. Several enhancements were made to support the [Scaled Agile Framework (SAFe)](https://msdn.microsoft.com/library/dn798712.aspx).</p>
...
<td>
<p>Added support for the Shared Parameters feature which allows you to [run tests with different data](https://msdn.microsoft.com/library/dd997832.aspx). </p>
<h4>The following changes were made to the default process templates:  </h4>
<ul>
...
<li>Process configuration changes: Replaced AgileConfiguration and CommonConfiguration with a single file, ProcessConfiguration. <a href="https://msdn.microsoft.com/en-us/library/hh500408.aspx">ProcessConfiguration</a> supports these additional features: portfolio backlogs, color assignment to WITs, tags added to the default columns on all backlog pages. </li>
...
<p>To update your team project with the latest reports, see [Upload reports to a team project](https://msdn.microsoft.com/library/dn130125.aspx).</p>
</li>
</ul>
</td>
</tr>
...
To update your existing team projects to access new features, [run the Configure Features wizard](../customize/configure-features-after-upgrade.md). In the event that you're upgrading from a much earlier version of TFS or you've customized your team project, you’ll need to make some manual updates.  
...
- [Before you upgrade TFS](../customize/before-you-upgrade-tfs.md)
- [Additional configuration options](../customize/additional-configuration-options.md)
- [Upload reports to a team project](https://msdn.microsoft.com/library/dn130125.aspx)
