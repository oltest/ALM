Title: Set alerts, get notified when changes occur | Visual Studio Online and TFS
Description: Set alerts to get notified when changes occur to source code, git, work items, and builds when using Visual Studio Online or Team Foundation Server (TFS)
ms.TocTitle: Set alerts
ms.ContentId: 50bac275-61fd-4ded-9c41-ec4c2412160e
...
1. Open alerts management (My alerts from your profile menu). If you don't see this option, then you must [configure an SMTP server to support TFS](https://msdn.microsoft.com/library/ms400808.aspx). 
...
5.	Define alert filters in the same way you define query filters.
	...
	For a list of available fields, see [Index of work item fields](https://msdn.microsoft.com/library/ms194971%28v=vs.140%29.aspx).
...
To administer alerts for a team project, you must be a member of the [Project Collection Administrator](https://msdn.microsoft.com/library/dd547204%28v=vs.140%29.aspx) or [Team Foundation Administrator](https://msdn.microsoft.com/library/bb552341%28v=vs.140%29.aspx) groups. If you’re not a member of these groups, you won't see the options available for administering alerts.
