Title: Update a customized process template to access new features | Team Foundation Server
Description: To use the Configure Features Wizard to update existing team projects, you may need to modify your custom process template when connecting to Team Foundation Server (TFS) 
ms.TocTitle: Update a customized process template to access new features
ms.ContentId: 09A88E62-F887-4139-923E-FACE6D759F92


*This topic applies only to team projects hosted on an on-premises Team Foundation Server (TFS). Team projects on Visual Studio Online [update automatically with each service upgrade](https://www.visualstudio.com/news/release-archive-vso). To update a custom team project hosted on Visual Studio Online, see [Import process](../import-process/import-process.md).* 
...
>**Tip: **Review [Changes made to process templates](../guidance/changes-to-process-templates.md) to learn about changes made to the default process templates to enable new features. 
...
1. Copy the ProcessConfiguration file from the **WorkItem Tracking/Process** folder of the downloaded process template to your customized template folder in the same location. 
	...
	Incorporate any customizations that you made to your ProcessConfiguration definition. For more information, see [Process Configuration XML Reference](https://msdn.microsoft.com/library/hh500408.aspx).
...
1. Apply the customizations that you've made to the new process template folder:
	...
	* Add custom WITs to the work item tracking folder, and update the **WorkItems** definition file as needed. See [Add type definitions for work items to a process template](https://msdn.microsoft.com/library/ms243883.aspx).
	...
	* Copy any additional process template files that you've customized to the appropriate process template folder. For a complete list of process template files and information about customizing them, see [Overview of process template files](https://msdn.microsoft.com/library/ms243856.aspx).
...
1. [Upload the process template](../guidance/manage-process-templates.md).
	...
	To verify your changes, create a test project. See [create a team project](https://msdn.microsoft.com/library/ms181477.aspx).
...
1.	Verify the features you want work as expected by exercising them as described in the following topics: 
	...
	<td>[Request feedback](https://msdn.microsoft.com/library/hh301769.aspx). <br/>
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>[Launch Storyboarding or link a storyboard to a work item](https://msdn.microsoft.com/library/hh409276.aspx).
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>[Activate the portfolio backlogs they work with to organize their backlogs](../backlogs/organize-backlog.md). 
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>
	You use Shared Parameter work items to [run tests with different data](https://msdn.microsoft.com/library/dd997832.aspx).   
	</td>
	</tr>
	<tr>
	<td>
...
* See [Overview of process template files](https://msdn.microsoft.com/library/ms243856.aspx) for information about each folder and file contained within the interdependent set of files.
...
* [Customize a process template](https://msdn.microsoft.com/library/ms243782.aspx)
...
You can post a question or search for answers to your update questions in one of these forums: [Team Foundation Server - Work Item Tracking](http://social.msdn.microsoft.com/Forums/tfsworkitemtracking/threads) or [Team Web Access](http://go.microsoft.com/fwlink/?LinkId=257843).
...
To learn more, see [Process configuration XML element reference](https://msdn.microsoft.com/library/hh500408.aspx).

###Q: How do I rename a work item type?

Use **witadmin renamewitd** command to change the name, and then update the Categories definition file. To learn more, see [Modify or add a custom work item type (WIT)](https://msdn.microsoft.com/library/hh409273.aspx).
