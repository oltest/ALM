Title: Add features using a manual update process | Team Foundation Server
Description: Manually update an existing team project to access new features - Team Foundation Server
ms.TocTitle: Add features using a manual update process
ms.ContentId: 21AB0EE7-FB48-43E6-89EA-EC438C5D4F21

*This topic applies only to team projects hosted on an on-premises Team Foundation Server (TFS). Team projects on Visual Studio Online [update automatically with each service upgrade](https://www.visualstudio.com/news/release-archive-vso). To update a custom team project hosted on Visual Studio Online, see [Import process](https://msdn.microsoft.com/Library/vs/alm/work/import-process/import-process).* 
...
<blockquote style="font-size: 13px">**Note:  **If you're upgrading a team project that was based on a Microsoft Solutions Framework (MSF) version 4.2 process template, follow the procedures provided in [Update a Team Project Based on an MSF v4.2 Process Template](https://msdn.microsoft.com/library/ff452591%28v=vs.110%29.aspx).<br/>
If you have several team projects you need to update, see [apply updates programmatically](configure-features-after-upgrade.md#program-updates).</blockquote>  
...
<blockquote style="font-size: 13px">**Note:  **Follow the links for each step to detail procedures provide later in this topic.</blockquote>  
...
<blockquote style="font-size: 13px">Go [here](https://msdn.microsoft.com/library/hh739067.aspx) if you use other WITs to support bug tracking or you've customized the workflow for the WITs you include in the Bug Category.</blockquote>
</td>
</tr>
<tr>
<td>
...
<li>To verify, [create a feedback request](https://msdn.microsoft.com/library/hh301769.aspx).  </li>
</ol>
...
If you're upgrading a team project that was based on version 5.0 of the Microsoft Solutions Framework (MSF) Agile process template, follow the procedures provided in [Update a Team Project Based on an MSF v4.2 Process Template](https://msdn.microsoft.com/library/hh500412%28v=vs.110%29.aspx).  </li>
</ul>
</li>
<li>[Update Categories](#update-categories): 
<ul>
...
<li>To verify, [open Storyboarding from the WIT you updated](https://msdn.microsoft.com/library/hh409276.aspx).  </li>
</ol>
<blockquote style="font-size: 13px">Go [here](https://msdn.microsoft.com/library/hh500409%28v=vs.110%29.aspx#storyboard) for step-by-step procedures.</blockquote></td>
</tr>
<tr>
<td>
Portfolio Backlogs
...
<blockquote style="font-size: 13px">Go [here](add-portfolio-backlogs.md) to add additional portfolio backlogs or further customize your portfolio backlogs.</blockquote>
</td>
</tr>
<tr>
<td>
...
<li>[Verify that you can add a shared parameter set or convert to shared parameters](https://msdn.microsoft.com/library/dd997832.aspx). </li>
</ol>
<blockquote style="font-size: 13px">Go [here](https://msdn.microsoft.com/en-us/library/hh500409%28v=vs.120%29.aspx) for step-by-step procedures.</blockquote>
</td>
</tr>
<tr>
<td>
...
<blockquote style="font-size: 13px">Go [here](https://msdn.microsoft.com/library/dn789837.aspx) for step-by-step procedures.</blockquote>  
</td>
</tr>
...
<blockquote style="font-size: 13px">Go [here](../guidance/manage-process-templates.md) to learn more about managing process templates.</blockquote>
...
<blockquote style="font-size: 13px">**Additional resources:** [Use categories to group work items](https://msdn.microsoft.com/library/dd695775.aspx), [Import and export categories](https://msdn.microsoft.com/library/dd273721.aspx)</blockquote>  
...
<li>Make the updates required to support your team project and add new features. If you've customized the workflow for WITs defined in the Requirement, Task, Bug, Epic, or Feature categories, review [Map workflow states to metastates](https://msdn.microsoft.com/library/hh500408.aspx#map).  <br/>
...
<blockquote style="font-size: 13px">**Additional resources:** [Import and export process configuration](https://msdn.microsoft.com/library/hh500413.aspx), [Configure Agile tools](https://msdn.microsoft.com/library/hh543813.aspx), and [ProcessConfiguration XML element reference](https://msdn.microsoft.com/library/hh500408.aspx)</blockquote>  
...
- [Overview of process template files](https://msdn.microsoft.com/library/ms243856%28v=vs.140%29.aspx)
 
If you need to rename a WIT, use **witadmin renamewitd** command to change the name, and then update the Categories definition file. See [Modify or add a custom work item type (WIT)](https://msdn.microsoft.com/library/hh409273.aspx).