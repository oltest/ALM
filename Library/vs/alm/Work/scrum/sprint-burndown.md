Title: Sprint burndown | Visual Studio Online and TFS
Description: Review progress during and at the end of a sprint when working in Visual Studio Online and Team Foundation Server
ms.TocTitle: Sprint burndown
ms.ContentId: 706331A0-3758-4575-9B51-AC828F57161B
...
You can use your team [velocity as input into the forecasting tool](https://msdn.microsoft.com/library/dn283465%28v=vs.140%29.aspx) to help plan your sprints.   
...
For Agile tools and on-premises TFS deployments, you can [specify the format that appears -- **h** for hours or **d** for days -- for the remaining work field](https://msdn.microsoft.com/library/hh500408%28v=vs.140%29.aspx#fields).  
