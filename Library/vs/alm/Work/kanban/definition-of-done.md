Title: Definition of Done | Visual Studio Online and TFS
Description: Support teams shared understanding by providing a definition for what "done" means for each column of the Kanban board when working in Visual Studio Online or Team Foundation Server
ms.TocTitle: Definition of done
ms.ContentId: f5b9223e-5be2-4df7-a735-02f0cb59a46b
...
2. Open the Definition of Done for the column that applies to the criteria you’ll enter. You can specify the Definition of Done for each intermediate column on your team’s Kanban board. 
	...
	**Visual Studio Online options:**  
	...
	![Kanban board, Coding column tab, Definition of done](_img/vso-kanban-board-definition-of-done-no-tags.png)  
...
![Definition Text](_img/vso-product-backlog-work-item-form-acceptance-criteria.png)  
