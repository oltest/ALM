...
1. From the [Team Foundation Server Administration Console](https://msdn.microsoft.com/library/ff357756.aspx).
...
reporting data the next time the [warehouse is rebuilt](https://msdn.microsoft.com/library/cc668753.aspx). Build 
