Title: Rename your Team Project | Team Foundation Server Administration
Description: You can rename your team project in TFS, and then there are some things you need to do to work with the renamed team project.
ms.TocTitle: Rename a team project
ms.ContentId: 23729f9a-9947-4fc1-89b0-07e3b52298ac
toc: show
...
## Performing a team project rename

### From the team project administration page

You can change the name of a team project from its administration overview page.

1. Open the administration overview page by choosing the ![Settings Icon (TFS Web Portal)](_img/project-rename/gearicon.png) gear icon in the top right.

2. Edit the name. 

	![Enter a new project name](_img/project-rename/ProjectRename1.png)
	
	If you don't see the textbox appear, then you're not a member of the Project Administrators group for that particular project. Learn how to [get added](https://msdn.microsoft.com/en-us/library/bb558971.aspx) to the Project Administrators group.
...
1. From your account's home page, use the ![Settings Icon (TFS Web Portal)](_img/project-rename/gearicon.png) gear icon to open the control panel and then go to the project collection administration page.

2. Rename the team project from its context menu.

	![Rename menu item in the team project context menu on the project collection administration page](_img/project-rename/collection-rename.png)

	If the rename action is disabled, then you're not a member of the Project Administrators group for that particular project. Learn how to [get added](https://msdn.microsoft.com/en-us/library/bb558971.aspx) to the Project Administrators group.
...
![Git code explorer tab](_img/project-rename/team-project-git-tabs.png)

![Remote URL for the repository](_img/project-rename/CloneURL.png)

#### Update your remote in Visual Studio 2015

1. Connect to the repo.

 ![Connect to the repository](_img/project-rename/RepoConnect.png)
 
2. Open the project settings.
 
 ![Project settings](_img/project-rename/ProjectSettings.png)

3. Open the repo settings.

 ![Repository settings](_img/project-rename/RepoSettings.png)

4. Edit the fetch and push remote references and paste the URL that you [copied from the remote repo](#copy_remote_repo_url).

 ![Edit remote](_img/project-rename/EditRepoSettings.png)
...
1. Refresh Team Explorer.
 ...
 ![Refresh Team Explorer](_img/project-rename/RefreshTeamExplorer.png)

2. Team Explorer now shows the updated repo name. 

 ![Team Explorer Updated](_img/project-rename/Result.png)


<a id="tfvc-server"></a>
### Update your TFVC server workspaces
If your team project uses TFVC with [server workspaces](https://msdn.microsoft.com/en-us/library/bb892960.aspx#server), these workspaces will need to be updated with the new project name. 
...
![Source control explorer, get latest version](_img/project-rename/tfvc-get.png)

<a id="tfvc-local"></a>
### Update your TFVC local workspaces
If your team uses TFVC with [local workspaces](https://msdn.microsoft.com/en-us/library/bb892960.aspx#local), these workspaces will need to be updated with the new project name.
For the following clients, execute a get or check-in and the workspace mapping will be corrected to use the new team project name:
...
1.  [Shelve your changes](https://msdn.microsoft.com/en-us/library/ms181404).

2.  [Create a new workspace](https://msdn.microsoft.com/en-us/library/ms181383.aspx) mapped to the new team project name.
...
[manually run the warehouse jobs and incremental analysis job](https://msdn.microsoft.com/en-us/library/ff400237.aspx)
...
- Excel reports and Excel web parts on MOSS will not show the right data until the execution of a couple of jobs.
	1. Warehouse job – [Run the warehouse jobs](https://msdn.microsoft.com/en-us/library/ff400237.aspx)
...
#### Q: What experience should I expect if I'm navigating a team project in the browser when it is renamed?
...
![Process Tab](_img/project-rename/lab-build-process.png)
