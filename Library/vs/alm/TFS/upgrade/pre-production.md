Title: Pre-production upgrade
ms.TocTitle: Pre-production upgrade
Description: Do a dry run of your upgrade in pre-production to avoid surprises in production.
ms.ContentId: 28B2A39E-71BB-49A0-A5EA-3F094446CE32
...
If you use the [scheduled backups wizard](https://msdn.microsoft.com/library/hh561429.aspx) to generate 
...
run the [ChangeServerId command](https://msdn.microsoft.com/library/ee349259.aspx). This will ensure that you
