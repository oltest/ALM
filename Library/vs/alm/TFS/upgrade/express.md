Title: Upgrading TFS Express
ms.TocTitle: Upgrading TFS Express
Description: Walkthrough of an Express upgrade
ms.ContentId: 25542ee9-2c35-4e95-be1e-6c1243119513
...
As with any upgrade, you will need to check [system requirements](..\administer\requirements.md) to
...
The upgrade process itself for TFS Express is quite simple - just install TFS Express 2015 and 
run the upgrade wizard. You will only need to make a couple of basic decisions, and when upgrading
