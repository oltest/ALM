Title: Create Excel reports from a work item query | Team Foundation Server
...
ms.TocTitle: Create Excel reports from a work item query
ms.ContentId: EBBA2C3A-A9F4-4808-B746-5DC0F039EA53

*You can use this feature only when you connect to a team project hosted an on-premises Team Foundation Server (TFS) and with SQL Server Analysis Services configured.*
...
2. Connect to the team project and choose the query.   
   ...
   If the server you need isn't listed, [add it now](https://msdn.microsoft.com/library/ms181475.aspx).  
...
###Q: Can I create reports if I'm working in Visual Studio Online?
...
###Q: Can I upload these reports to a project portal?
   ...
   **A:** Yes. See [Manage documents and document libraries](https://msdn.microsoft.com/library/ms181484.aspx).
