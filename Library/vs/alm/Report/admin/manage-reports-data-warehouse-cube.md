Title: Manage data warehouse and analysis services cube | Team Foundation Server
...
ms.TocTitle:  Manage the data warehouse and cube
ms.ContentId: 3D57E047-4922-4B4B-8736-A68B2895E846
...
With SQL Server Reporting Services, you gain access to many default Excel and SQL Server Reporting Services reports. These reports aggregate metrics from work items, version control, test results, and builds. See [Create, customize, and manage reports for Visual Studio ALM](https://msdn.microsoft.com/library/bb649552.aspx).

Without these services, you can [create status and trend charts from work item queries](https://msdn.microsoft.com/library/dn407521.aspx) directly from the operational data stores.

##View, add, update, or customize reports or report functionality
You use work item fields to track data for a work item type, to define the filter criteria for queries, and to design reports. To support reporting, you can add fields or change the attributes of existing fields. When you add or modify fields, you will want to apply systematic naming conventions to make sure that data is logically grouped into folders in the cube. To learn more, see [Add or modify work item fields to support reporting](https://msdn.microsoft.com/library/ee921481.aspx). 
...
Depending on the process template that you use to create your team project, you may have several reports already defined. You can customize these reports additionally or create new reports. These reports may contain new data fields that you added to work item types. See [Create, customize, and manage reports for Visual Studio ALM](https://msdn.microsoft.com/library/bb649552.aspx).
...
- [Reportable fields reference for Visual Studio ALM](https://msdn.microsoft.com/library/jj153003.aspx) provides definitions for eacha reportable field. A default set of fields appears in the relational warehouse database or the cube. These fields have a reportable attribute value of Detail, Dimension, or Measure. 
[Understanding SQL Server and SQL Server Reporting Services](https://msdn.microsoft.com/library/bb552243.aspx) describes the relationships and dependencies between SQL Server and TFS.
 
- [Manage team project collections](https://msdn.microsoft.com/library/dd236915.aspx) describes how you can enable and disable data that flows into the data warehouse by editing the reporting configuration for your team project collections. After you add a report server to your deployment, you can configure reporting resources for your team project collections and the projects in those collections.
