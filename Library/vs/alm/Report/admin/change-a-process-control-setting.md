...
ms.TocTitle: Change a process control setting  
ms.ContentId: 48F5B9C9-66B4-4211-8622-5F93CDA9A19A
...
**Requirements** 
  ...
  * You must be a member of the **Team Foundation Administrators** security group, or you must have the server-level **Administer warehouse** permission set to **Allow**. See [Set administrator permissions for Team Foundation Server](https://msdn.microsoft.com/library/bb552341.aspx).  
